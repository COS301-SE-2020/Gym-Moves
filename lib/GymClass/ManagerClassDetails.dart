...
class ManagerClassDetailsState extends State<ManagerClassDetails> {
  ...
  void checkIfSureAboutDelete() {
    Widget yesButton = FlatButton(
      child: Text("Delete", style: TextStyle(color: Color(0xff513369))),
      onPressed: () {
        Navigator.pop(context);
        _deleteClass();
      },
    ...
    Widget noButton = FlatButton(
      child: Text("Cancel", style: TextStyle(color: Color(0xff513369))),
      onPressed: () {
        Navigator.pop(context);
    ...
    Widget okButton = FlatButton(
      ...
      onPressed: () {
        ...
        if (heading == "Great news!") {
          ...
          Navigator.pop(context);
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => ManagerViewClasses()));
        }
      },
    );
    AlertDialog alert = AlertDialog(
