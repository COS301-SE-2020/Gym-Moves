 ...
 */
class ViewAllClassesMember extends StatefulWidget {
  const ViewAllClassesMember({Key key}) : super(key: key);

  @override
  ViewAllClassesMemberState createState() => ViewAllClassesMemberState();
}
    ...
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          Stack(children: <Widget>[
            ...
            Transform.translate(
              offset: Offset(0.5 * media.size.width, 0.4 * media.size.height),
              child: SvgPicture.string(
                underline,
            ...
            Transform.translate(
                offset:
                Offset(0.0, 0.33 * media.size.height),
                child: Container(
                    child: GestureDetector(
                      onTap: () {
                        Navigator.pop(context);
