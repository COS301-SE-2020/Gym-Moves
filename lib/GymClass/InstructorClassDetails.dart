...
class InstructorClassDetails extends StatefulWidget {
  ...
  InstructorClassDetails(
      {Key key, this.instructorName, this.className, this.classDay, this.classStart,
        this.availableSpots, this.description, this.classId, this.cancel,
        this.max, this.instructorUsername, this.classEnd}) : super(key: key);

  @override
  InstructorClassDetailsState createState() => InstructorClassDetailsState();
}
 ...
 */
class InstructorClassDetailsState extends State<InstructorClassDetails> {
  InstructorClassDetailsState({Key key});
                  ...
                  children: <Widget>[
                    ...
                    Row(
                        children: [
                          Container(
                            padding:
                            EdgeInsets.fromLTRB(0.45 * media.size.width, 0.0, 0.02 * media.size.width, 0.0),
                            child: FlatButton(
  ...
  cancelClass() async {
    ...
    else if (cancelString == "Resume Class") {
