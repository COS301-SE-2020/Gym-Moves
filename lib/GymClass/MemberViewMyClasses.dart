 ...
 */
class MemberViewMyClasses extends StatefulWidget {
  const MemberViewMyClasses({Key key}) : super(key: key);

  @override
  MemberViewMyClassesState createState() => MemberViewMyClassesState();
}
...
Purpose:
 */
class MemberViewMyClassesState extends State<MemberViewMyClasses> {
...
*/
  Future<String> _makeGetRequest() async {
    ...
    String url =
        'https://gymmoveswebapi.azurewebsites.net/api/classes/userlist?username=$username';
