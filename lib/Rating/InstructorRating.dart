...
Purpose:
  This class is used to create the InstructorRatingState that builds the UI for
  viewing instructor details. It allows for widgets to be dynamically added as well.

 */
class InstructorRating extends StatefulWidget {
  ...
  @override
  InstructorRatingState createState() => InstructorRatingState();
}
/*
Class Name:
  InstructorRatingState

Purpose:
  This class is used to create the UI for users to see the instructor's details. It also
  handles the request to the API.
 */
class InstructorRatingState extends State<InstructorRating> {
  InstructorRatingState({Key key});
    ...
    return Scaffold(
        ...
        body: Column(children: <Widget>[
          Stack(children: <Widget>[
            ...
            Transform.translate(
              offset: Offset(0.0 * 0.0 * media.size.width,
  ...
  /*
   ...
   Purpose:
    This method will return the stars to show the instructor's rating.
  ...
  void sendRating() async {
    ...
    if (response.statusCode == 200) {
      _alertDialog('Success!', 'Instructor Rated Successfully!');
    } else {
      _alertDialog('Error', 'Please try again later.');
    }
  }
...
*/
  Future<String> _makeGetRequest() async {
    ...
    if (response.statusCode == 200) {
      ...
      return 'Failed to retrieve user data. Please Try Again Later';
    }
  }
  ...
  Widget getClasses(MediaQueryData media) {
    ...
    if (classesJson.length == 0) {
      return Container(
          ...
          width: media.size.width,
          child: Text(
            'The instructor does not have and classes',
            style: TextStyle(
              fontFamily: 'Roboto',
